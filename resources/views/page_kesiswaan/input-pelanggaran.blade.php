    ...
    <div class="card" style="border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">Data Pelanggaran</h6>
                <div>
                    <a href="/kesiswaan/riwayat-pelanggaran" class="btn btn-warning btn-sm me-2">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/kesiswaan/delete-pelanggaran/{{ $p->id }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus? Data akan disimpan ke riwayat pelanggaran.')">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formPelanggaran" action="/kesiswaan/store-pelanggaran" method="POST">
                        @csrf
                        <div class="mb-3">
                            ...
                            <select name="siswa_id" class="form-control" required>
                                ...
                                @foreach($siswa as $s)
                                <option value="{{ $s->id }}">{{ $s->nama_siswa }} - {{ $s->kelas->nama_kelas ?? 'Kelas tidak ditemukan' }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
