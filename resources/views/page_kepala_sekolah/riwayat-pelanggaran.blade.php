    ...
    <div class="row mt-4">
        <div class="col-md-3">
            <div class="card text-center" style="border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <div class="card-body">
                    <h4 class="text-danger">{{ $pelanggaran->total() }}</h4>
        ...
        <div class="col-md-3">
            <div class="card text-center" style="border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <div class="card-body">
                    <h4 class="text-warning">{{ $pelanggaran->sum('poin') }}</h4>
        ...
        <div class="col-md-3">
            <div class="card text-center" style="border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <div class="card-body">
                    <h4 class="text-info">{{ $pelanggaran->unique('siswa_id')->count() }}</h4>
                    <p class="text-muted mb-0">Siswa Terlibat</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card text-center" style="border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <div class="card-body">
                    <h4 class="text-success">{{ $pelanggaran->where('sanksi', '!=', null)->count() }}</h4>
                    <p class="text-muted mb-0">Sudah Disanksi</p>
                </div>
            </div>
        </div>
    </div>
